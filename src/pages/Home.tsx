...
const Home = () => {
  ...
  return (
    <main id='home' className="min-h-screen bg-gray-100 dark:bg-gray-900 flex flex-col items-center justify-center gap-4 relative p-4 transition-colors duration-300">
        {/* About */}
