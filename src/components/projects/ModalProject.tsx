...
const ModalProject: React.FC<ModalProjectProps> = ({ isOpen, onClose, projectData }) => {
              ...
              <div className="relative h-full rounded-2xl border p-2 md:rounded-3xl md:p-3"
                ...
                <div 
                  ...
                  style={{
                    ...
                    transition: "background-color 0.3s ease",
                    boxShadow: "var(--project-shadow, rgba(0, 0, 0, 0.05) 0px 5px 6px 0px)",
                  }}
                >
                  <div className="relative flex flex-1 flex-col justify-between gap-6">
                    ...
                    <div className="space-y-6">
                      {/* Title */}
                      <h3 
                        className="text-xl font-semibold text-balance md:text-2xl"
                        style={{
